...
def water_mean_std(path, out_path): 
    ...
    flow_mean_k1_1=np.nanmean(flow_mean_list_all_1, axis=0)
    flow_std_k1_1=np.nanstd(flow_mean_list_all_1, axis=0)
    
    
    first_values_yz_neg_x0_mean_k1_1=np.nanmean(first_values_yz_neg_x0_list_k1_1, axis=0)
    first_values_yz_pos_x1_mean_k1_1=np.nanmean(first_values_yz_pos_x1_list_k1_1, axis=0)
    first_values_yz_pos_x2_mean_k1_1=np.nanmean(first_values_yz_pos_x2_list_k1_1, axis=0)
    first_values_yz_neg_x2_mean_k1_1=np.nanmean(first_values_yz_neg_x2_list_k1_1, axis=0)
    first_values_xz_pos_y2_mean_k1_1=np.nanmean(first_values_xz_pos_y2_list_k1_1, axis=0)
    first_values_xz_neg_y2_mean_k1_1=np.nanmean(first_values_xz_neg_y2_list_k1_1, axis=0)
    
    first_values_yz_neg_x0_std_k1_1=np.nanstd(first_values_yz_neg_x0_list_k1_1, axis=0)
    first_values_yz_pos_x1_std_k1_1=np.nanstd(first_values_yz_pos_x1_list_k1_1, axis=0)
    first_values_yz_pos_x2_std_k1_1=np.nanstd(first_values_yz_pos_x2_list_k1_1, axis=0)
    first_values_yz_neg_x2_std_k1_1=np.nanstd(first_values_yz_neg_x2_list_k1_1, axis=0)
    first_values_xz_pos_y2_std_k1_1=np.nanstd(first_values_xz_pos_y2_list_k1_1, axis=0)
    first_values_xz_neg_y2_std_k1_1=np.nanstd(first_values_xz_neg_y2_list_k1_1, axis=0)
    
    
    region_mean_values_1=np.array(region_mean_values_1)
    region_mean_k1_1=np.nanmean(region_mean_values_1, axis=0)
    region_std_k1_1=np.nanstd(region_mean_values_1, axis=0)
    
    
    
    
    flow_mean_list_all_ref_1=np.array(flow_mean_list_all_ref_1)
    flow_mean_k1_1_ref=np.nanmean(flow_mean_list_all_ref_1, axis=0)
    flow_std_k1_1_ref=np.nanstd(flow_mean_list_all_ref_1, axis=0)
    
    first_values_yz_neg_x0_mean_k1_1_ref=np.nanmean(first_values_yz_neg_x0_list_k1_1_ref, axis=0)
    first_values_yz_pos_x1_mean_k1_1_ref=np.nanmean(first_values_yz_pos_x1_list_k1_1_ref, axis=0)
    first_values_yz_pos_x2_mean_k1_1_ref=np.nanmean(first_values_yz_pos_x2_list_k1_1_ref, axis=0)
    first_values_yz_neg_x2_mean_k1_1_ref=np.nanmean(first_values_yz_neg_x2_list_k1_1_ref, axis=0)
    first_values_xz_pos_y2_mean_k1_1_ref=np.nanmean(first_values_xz_pos_y2_list_k1_1_ref, axis=0)
    first_values_xz_neg_y2_mean_k1_1_ref=np.nanmean(first_values_xz_neg_y2_list_k1_1_ref, axis=0)
    
    first_values_yz_neg_x0_std_k1_1_ref=np.nanstd(first_values_yz_neg_x0_list_k1_1_ref, axis=0)
    first_values_yz_pos_x1_std_k1_1_ref=np.nanstd(first_values_yz_pos_x1_list_k1_1_ref, axis=0)
    first_values_yz_pos_x2_std_k1_1_ref=np.nanstd(first_values_yz_pos_x2_list_k1_1_ref, axis=0)
    first_values_yz_neg_x2_std_k1_1_ref=np.nanstd(first_values_yz_neg_x2_list_k1_1_ref, axis=0)
    first_values_xz_pos_y2_std_k1_1_ref=np.nanstd(first_values_xz_pos_y2_list_k1_1_ref, axis=0)
    first_values_xz_neg_y2_std_k1_1_ref=np.nanstd(first_values_xz_neg_y2_list_k1_1_ref, axis=0)
    
    region_mean_values_ref_1=np.array(region_mean_values_ref_1)
    region_mean_k1_1_ref=np.nanmean(region_mean_values_ref_1, axis=0)
    region_std_k1_1_ref=np.nanstd(region_mean_values_ref_1, axis=0)
...
def wat1_wat2_mean_std(path_1, path_2, out_path): 
    ...
    flow_mean_k1_2=np.nanmean(flow_mean_list_all_2, axis=0)
    flow_std_k1_2=np.nanstd(flow_mean_list_all_2, axis=0)
    
    
    first_values_yz_neg_x0_mean_k1_2=np.nanmean(first_values_yz_neg_x0_list_k1_2, axis=0)
    first_values_yz_pos_x1_mean_k1_2=np.nanmean(first_values_yz_pos_x1_list_k1_2, axis=0)
    first_values_yz_pos_x2_mean_k1_2=np.nanmean(first_values_yz_pos_x2_list_k1_2, axis=0)
    first_values_yz_neg_x2_mean_k1_2=np.nanmean(first_values_yz_neg_x2_list_k1_2, axis=0)
    first_values_xz_pos_y2_mean_k1_2=np.nanmean(first_values_xz_pos_y2_list_k1_2, axis=0)
    first_values_xz_neg_y2_mean_k1_2=np.nanmean(first_values_xz_neg_y2_list_k1_2, axis=0)
    
    first_values_yz_neg_x0_std_k1_2=np.nanstd(first_values_yz_neg_x0_list_k1_2, axis=0)
    first_values_yz_pos_x1_std_k1_2=np.nanstd(first_values_yz_pos_x1_list_k1_2, axis=0)
    first_values_yz_pos_x2_std_k1_2=np.nanstd(first_values_yz_pos_x2_list_k1_2, axis=0)
    first_values_yz_neg_x2_std_k1_2=np.nanstd(first_values_yz_neg_x2_list_k1_2, axis=0)
    first_values_xz_pos_y2_std_k1_2=np.nanstd(first_values_xz_pos_y2_list_k1_2, axis=0)
    first_values_xz_neg_y2_std_k1_2=np.nanstd(first_values_xz_neg_y2_list_k1_2, axis=0)
    
    
    region_mean_values_2=np.array(region_mean_values_2)
    region_mean_k1_2=np.nanmean(region_mean_values_2, axis=0)
    region_std_k1_2=np.nanstd(region_mean_values_2, axis=0)
    
    
    
    
    flow_mean_list_all_ref_2=np.array(flow_mean_list_all_ref_2)
    flow_mean_k1_2_ref=np.nanmean(flow_mean_list_all_ref_2, axis=0)
    flow_std_k1_2_ref=np.nanstd(flow_mean_list_all_ref_2, axis=0)
    
    first_values_yz_neg_x0_mean_k1_2_ref=np.nanmean(first_values_yz_neg_x0_list_k1_2_ref, axis=0)
    first_values_yz_pos_x1_mean_k1_2_ref=np.nanmean(first_values_yz_pos_x1_list_k1_2_ref, axis=0)
    first_values_yz_pos_x2_mean_k1_2_ref=np.nanmean(first_values_yz_pos_x2_list_k1_2_ref, axis=0)
    first_values_yz_neg_x2_mean_k1_2_ref=np.nanmean(first_values_yz_neg_x2_list_k1_2_ref, axis=0)
    first_values_xz_pos_y2_mean_k1_2_ref=np.nanmean(first_values_xz_pos_y2_list_k1_2_ref, axis=0)
    first_values_xz_neg_y2_mean_k1_2_ref=np.nanmean(first_values_xz_neg_y2_list_k1_2_ref, axis=0)
    
    first_values_yz_neg_x0_std_k1_2_ref=np.nanstd(first_values_yz_neg_x0_list_k1_2_ref, axis=0)
    first_values_yz_pos_x1_std_k1_2_ref=np.nanstd(first_values_yz_pos_x1_list_k1_2_ref, axis=0)
    first_values_yz_pos_x2_std_k1_2_ref=np.nanstd(first_values_yz_pos_x2_list_k1_2_ref, axis=0)
    first_values_yz_neg_x2_std_k1_2_ref=np.nanstd(first_values_yz_neg_x2_list_k1_2_ref, axis=0)
    first_values_xz_pos_y2_std_k1_2_ref=np.nanstd(first_values_xz_pos_y2_list_k1_2_ref, axis=0)
    first_values_xz_neg_y2_std_k1_2_ref=np.nanstd(first_values_xz_neg_y2_list_k1_2_ref, axis=0)
    
    region_mean_values_ref_2=np.array(region_mean_values_ref_2)
    region_mean_k1_2_ref=np.nanmean(region_mean_values_ref_2, axis=0)
    region_std_k1_2_ref=np.nanstd(region_mean_values_ref_2, axis=0)
    ...
    flow_mean_k1_3=np.nanmean(flow_mean_list_all_3, axis=0)
    flow_std_k1_3=np.nanstd(flow_mean_list_all_3, axis=0)
    #%%
    
    first_values_yz_neg_x0_mean_k1_3=np.nanmean(np.array(first_values_yz_neg_x0_list_k1_2)/np.array(first_values_yz_neg_x0_list_k1_1), axis=0)
    first_values_yz_pos_x1_mean_k1_3=np.nanmean(np.array(first_values_yz_pos_x1_list_k1_2)/np.array(first_values_yz_pos_x1_list_k1_1), axis=0)
    first_values_yz_pos_x2_mean_k1_3=np.nanmean(np.array(first_values_yz_pos_x2_list_k1_2)/np.array(first_values_yz_pos_x2_list_k1_1), axis=0)
    first_values_yz_neg_x2_mean_k1_3=np.nanmean(np.array(first_values_yz_neg_x2_list_k1_2)/np.array(first_values_yz_neg_x2_list_k1_1), axis=0)
    first_values_xz_pos_y2_mean_k1_3=np.nanmean(np.array(first_values_xz_pos_y2_list_k1_2)/np.array(first_values_xz_pos_y2_list_k1_1), axis=0)
    first_values_xz_neg_y2_mean_k1_3=np.nanmean(np.array(first_values_xz_neg_y2_list_k1_2)/np.array(first_values_xz_neg_y2_list_k1_1), axis=0)
    
    first_values_yz_neg_x0_std_k1_3=np.nanstd(np.array(first_values_yz_neg_x0_list_k1_2)/np.array(first_values_yz_neg_x0_list_k1_1), axis=0)
    first_values_yz_pos_x1_std_k1_3=np.nanstd(np.array(first_values_yz_pos_x1_list_k1_2)/np.array(first_values_yz_pos_x1_list_k1_1), axis=0)
    first_values_yz_pos_x2_std_k1_3=np.nanstd(np.array(first_values_yz_pos_x2_list_k1_2)/np.array(first_values_yz_pos_x2_list_k1_1), axis=0)
    first_values_yz_neg_x2_std_k1_3=np.nanstd(np.array(first_values_yz_neg_x2_list_k1_2)/np.array(first_values_yz_neg_x2_list_k1_1), axis=0)
    first_values_xz_pos_y2_std_k1_3=np.nanstd(np.array(first_values_xz_pos_y2_list_k1_2)/np.array(first_values_xz_pos_y2_list_k1_1), axis=0)
    first_values_xz_neg_y2_std_k1_3=np.nanstd(np.array(first_values_xz_neg_y2_list_k1_2)/np.array(first_values_xz_neg_y2_list_k1_1), axis=0)
    
    #%%
    region_mean_values_3=np.array(region_mean_values_3)
    region_mean_k1_3=np.nanmean(region_mean_values_3, axis=0)
    region_std_k1_3=np.nanstd(region_mean_values_3, axis=0)
    
    
    
    
    flow_mean_list_all_ref_3=np.array(flow_mean_list_all_ref_3)
    flow_mean_k1_3_ref=np.nanmean(flow_mean_list_all_ref_3, axis=0)
    flow_std_k1_3_ref=np.nanstd(flow_mean_list_all_ref_3, axis=0)
    
    first_values_yz_neg_x0_mean_k1_3_ref=np.nanmean(np.array(first_values_yz_neg_x0_list_k1_2_ref)/np.array(first_values_yz_neg_x0_list_k1_1_ref), axis=0)
    first_values_yz_pos_x1_mean_k1_3_ref=np.nanmean(np.array(first_values_yz_pos_x1_list_k1_2_ref)/np.array(first_values_yz_pos_x1_list_k1_1_ref), axis=0)
    first_values_yz_pos_x2_mean_k1_3_ref=np.nanmean(np.array(first_values_yz_pos_x2_list_k1_2_ref)/np.array(first_values_yz_pos_x2_list_k1_1_ref), axis=0)
    first_values_yz_neg_x2_mean_k1_3_ref=np.nanmean(np.array(first_values_yz_neg_x2_list_k1_2_ref)/np.array(first_values_yz_neg_x2_list_k1_1_ref), axis=0)
    first_values_xz_pos_y2_mean_k1_3_ref=np.nanmean(np.array(first_values_xz_pos_y2_list_k1_2_ref)/np.array(first_values_xz_pos_y2_list_k1_1_ref), axis=0)
    first_values_xz_neg_y2_mean_k1_3_ref=np.nanmean(np.array(first_values_xz_neg_y2_list_k1_2_ref)/np.array(first_values_xz_neg_y2_list_k1_1_ref), axis=0)
    
    first_values_yz_neg_x0_std_k1_3_ref=np.nanstd(np.array(first_values_yz_neg_x0_list_k1_2_ref)/np.array(first_values_yz_neg_x0_list_k1_1_ref), axis=0)
    first_values_yz_pos_x1_std_k1_3_ref=np.nanstd(np.array(first_values_yz_pos_x1_list_k1_2_ref)/np.array(first_values_yz_pos_x1_list_k1_1_ref), axis=0)
    first_values_yz_pos_x2_std_k1_3_ref=np.nanstd(np.array(first_values_yz_pos_x2_list_k1_2_ref)/np.array(first_values_yz_pos_x2_list_k1_1_ref), axis=0)
    first_values_yz_neg_x2_std_k1_3_ref=np.nanstd(np.array(first_values_yz_neg_x2_list_k1_2_ref)/np.array(first_values_yz_neg_x2_list_k1_1_ref), axis=0)
    first_values_xz_pos_y2_std_k1_3_ref=np.nanstd(np.array(first_values_xz_pos_y2_list_k1_2_ref)/np.array(first_values_xz_pos_y2_list_k1_1_ref), axis=0)
    first_values_xz_neg_y2_std_k1_3_ref=np.nanstd(np.array(first_values_xz_neg_y2_list_k1_2_ref)/np.array(first_values_xz_neg_y2_list_k1_1_ref), axis=0)
    
    
    region_mean_values_ref_3=np.array(region_mean_values_ref_3)
    region_mean_k1_3_ref=np.nanmean(region_mean_values_ref_3, axis=0)
    region_std_k1_3_ref=np.nanstd(region_mean_values_ref_3, axis=0)
...
def R_I_mean_std(path, out_path):
    ...
    flow_mean_R_I=np.nanmean(flow_mean_list_all, axis=0)
    flow_std_R_I=np.nanstd(flow_mean_list_all, axis=0)
    
    
    region_mean_values=np.array(region_mean_values)
    region_mean_R_I=np.nanmean(region_mean_values, axis=0)
    region_std_R_I=np.nanstd(region_mean_values, axis=0)
...
def R_I_C_mean_std(path, out_path):
    ...
    flow_mean_list_all=np.array(flow_mean_list_all)
    flow_mean_R_I_C=np.nanmean(flow_mean_list_all, axis=0)
    flow_std_R_I_C=np.nanstd(flow_mean_list_all, axis=0)
    
    
    region_mean_values=np.array(region_mean_values)
    region_mean_R_I_C=np.nanmean(region_mean_values, axis=0)
    region_std_R_I_C=np.nanstd(region_mean_values, axis=0)
...
def process_k1(root):
    ...
    def run_processing():
        ...
        try:
            ...
            messagebox.showinfo("Klart", "Nytt normalmaterial har skapats")
            back_to_main(root)
        except Exception as e:
            calculating_label.config(text="")
